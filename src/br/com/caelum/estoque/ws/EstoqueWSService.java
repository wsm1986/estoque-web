 ...
 * 2016-07-18T16:01:36.153-03:00
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/home/dbaldani/caelum/estoque-web/src/EstoqueWSService.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/dbaldani/caelum/estoque-web/src/EstoqueWSService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/dbaldani/caelum/estoque-web/src/EstoqueWSService.wsdl");
        }
        WSDL_LOCATION = url;
    }
